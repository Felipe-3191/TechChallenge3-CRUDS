...
public class CondutorController {
    ...
    @PutMapping
    public ResponseEntity<CondutorDTO> atualizarCondutor(@RequestBody @Valid CondutorDTO condutor) {

        return ResponseEntity.status(HttpStatus.OK).body(service.atualizarCondutor(condutor));
    }
